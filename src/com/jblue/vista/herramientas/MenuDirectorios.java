 ...
 * @author jp
 */
public class MenuDirectorios extends VentanaSimple {
    ...
    private void cargarLista() {
        ...
        for (OUsuarios i : cache) {
            ...
            int index = lista.indexOf(String.format(dir_nom_formato, i.getId(), i.toString()));
            if (index < 0) {
                modelo_lista.addElement(i.toString());
            }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        for (OUsuarios i : cache) {
            ...
            s.append("/").append(String.format(dir_nom_formato, i.getId(), i.toString()));
