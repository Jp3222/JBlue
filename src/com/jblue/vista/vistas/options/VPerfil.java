 ...
 * @author juan-campos
 */
public final class VPerfil extends VistaExtendida implements EvtSetInfoGrafica {

    private final OPersonal personal;
    private final List<JButton> option;
    ...
    public VPerfil() {
        initComponents();
        personal = Sesion.getInstancia().getUsuario();
