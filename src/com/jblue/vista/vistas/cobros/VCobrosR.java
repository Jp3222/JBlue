 ...
 * @author jp
 */
class VCobrosR extends SuperVista {
    ...
    private void setInfoEnPantalla(OUsuarios i) {
        ...
        Func.habilitarComponentes(lista.size() < 12, btn_cobrar, btn_limpiar);
    }

    public void pintarMesesPagados(List<String> lista) {
    ...
    private void habilitarComponentes(boolean o) {
        Func.habilitarComponentes(o, btn_info_usuarios,
                btn_cobrar,
                btn_cancelar,
                btn_limpiar,
                btn_recargos,
                ...
                btn_movimientos,
                chb_todos);
        Func.habilitarComponentes(o, cbx_meses);
    }
...
//            Func.ocultarComponente(!panel_izq.isVisible(), panel_izq);
//        }
