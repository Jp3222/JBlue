 ...
 * @author jp
 */
public class AppEstrucConfig {

    private static AppEstrucConfig instancia;

    public synchronized static AppEstrucConfig getInstancia() {
        if (instancia == null) {
            instancia = new AppEstrucConfig();
        }
        return instancia;
    }
    ...
    public void prop() {
        ...
        configs.put("Titulo", AppInfo.NOMBRE_DEL_PROGRAMA + " " + AppInfo.VERSION_DEL_PROGRAMA);
    }
