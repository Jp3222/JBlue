...
public class UserService implements Serializable {
    ...
    public UserService(String process_id, UserDao user_dao, HysHistoryDAO history_dao, ProcessDAO process_dao) {
    ...
    public UserService(String process_id, boolean flag_dev, String name_module) {
        this.process_id = process_id;
    ...
    public boolean save(JDBConnection connection, UserDTO user) {
        boolean res = false;
        try {
            ...
            res = process_dao.startProcess(connection, process_id, String.valueOf(key));
            if (!res) {
