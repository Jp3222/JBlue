...
/**
 * Servicio encargado de la lógica de negocio, validaciones preventivas 
 * y orquestación de auditoría para la carga de documentos por lotes.
 *
...
public class UserDocumentationService extends AbstractService {
    ...
    /**
     * Procesa e inserta un lote completo de documentos digitalizados de forma atómica,
     * enriqueciendo sus IDs y registrando el evento de éxito en la bitácora de programa.
     * * @param connection Conexión activa controlada por el orquestador macro.
     * @param dtoList Lista de DTOs con la información y archivos binarios en Base64.
     * @return true si todo el lote y su bitácora se asentaron correctamente; false en caso contrario.
     */
